...
download.file(url="https://github.com/eogasawara/CSA/raw/master/toy/toydataset.xlsx", destfile="toydataset.xlsx", mode="wb")
mydata <- read.xlsx("toydataset.xlsx", "data")
...
save(vectorMatrix, file = "toydataset.RData") 
